    ...
    <>
      <div className="container-fluid">
        <div className="row d-flex">
          <div className="col-sm-2 bg-dark d-flex flex-column justify-content-between min-vh-100" role="button">
            <div className="mt-2">
              ...
              <button className='button fs-5 p-1 m-3 text-center fw-bold' style={{ color: "#fa7b05" }}>Create new</button>
              </div>
              ...
              <ul className="nav nav-pills flex-column mt-2 mt-sm-0 " id="parentM">
                <li className="nav-item my-1 py-2 py-sm-0">
                  ...
                  >
                    <HiSquare3Stack3D className='me-1' style={{"font-size":"30px"}}/>
                ...
                <li className="nav-item my-1 py-2 py-sm-0">
                  <a
                    ...
                    className="nav-link text-white text-center text-sm-start"
                  >
                    <MdDesignServices className='me-1' style={{"font-size":"30px"}}/>
                ...
                <li className="nav-item my-1 py-2 py-sm-0">
                  <a
                    ...
                    className="nav-link text-white text-center text-sm-start"
                  >
                   <ImProfile className="me-1" style={{'font-size':"30px"}}/>
            ...
            <div className="dropdown open mb-3 text-center">
              <a className="btn btn-secondary border-none dropdown-toggle" type="button" id="triggerId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
