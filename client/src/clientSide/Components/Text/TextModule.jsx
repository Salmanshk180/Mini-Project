    ...
    <>
      <div>
        <Container className="d-flex flex-column">
          <Button className="my-1 fs-1 border-0 bg-white text-dark fw-bold" onClick={()=>addHeadingOne()}>
            Add Heading
          </Button>
          <Button className="my-1 fs-3  border-0 bg-white text-dark fw-bold">
            Add Heading
          </Button>
          <Button className="my-1 fs-6  border-0 bg-white text-dark fw-bold">
            Add Heading
          </Button>
          <div
            className="my-2"
